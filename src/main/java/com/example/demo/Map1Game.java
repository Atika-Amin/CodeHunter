...
public class Map1Game implements GameInterface{
    ...
    private final String mapName = "map1"; // Add this near other class fields
    // Declare this flag at the top of your class
    private boolean farewellTriggered = false;

    public Map1Game(Stage stage) {
        this.stage = stage;
    }
    ...
    public void start() throws Exception {
        ...
        if (selectedAvatar == 0) {
            ...
            player = new Player2(1 * TILE_SIZE, 6.5 * TILE_SIZE, tileMap);
        }
        else if(selectedAvatar==2){
            player=new Player3(1 * TILE_SIZE, 6.5 * TILE_SIZE, tileMap);
        }
        ...
        treasureManager = new TreasureManager(tileMap);
        ...
        gameLoop = new AnimationTimer() {
            ...
            public void handle(long now) {
                ...
                if (player.isAlive() && !isPaused) {
                    ...
                    winManager.checkAndShowWin(treasureManager, root, canvas, Map1Game.this, 5, mapName);
