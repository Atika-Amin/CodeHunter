...
public class Map4Game implements GameInterface{
    ...
    private TreasureManager3 treasureManager;
    ...
    private final String mapName = "map4"; // Add this near other class fields
    ...
    public void start() throws Exception {
        ...
        treasureManager = new TreasureManager3(tileMap);
