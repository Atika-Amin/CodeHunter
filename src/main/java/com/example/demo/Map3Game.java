...
public class Map3Game implements GameInterface{
    ...
    private TreasureManager2 treasureManager;
    ...
    private final String mapName = "map3"; // Add this near other class fields
    ...
    public void start() throws Exception {
        ...
        InputStream mapStream = getClass().getResourceAsStream("/assets/maps/map4.tmj");
        ...
        treasureManager = new TreasureManager2(tileMap);
        ...
        gameLoop = new AnimationTimer() {
            ...
            public void handle(long now) {
                if (player.isAlive() && !isPaused) {
                    ...
                    winManager.checkAndShowWin(treasureManager, root, canvas, Map3Game.this,3,mapName);
