...
public class Enemy {
    ...
    private static final double DETECTION_RADIUS = 40;
    ...
    public Enemy( String front, String back, String left, String right,
        ...
        this.deadFront = SpriteLoader.loadFrames(deadFront, 64, 64, 2, 3);
        this.deadBack = SpriteLoader.loadFrames(deadBack, 64, 64, 2, 3);
        this.deadLeft = SpriteLoader.loadFrames(deadLeft, 64, 64, 2, 3);
        this.deadRight = SpriteLoader.loadFrames(deadRight, 64, 64, 2, 3);
       this.health=health;
        ...
        if (chasing) {
            ...
            if (isCollidingWithPlayer(player)) {
               // SoundManager.playMonsterAttack();
                player.takeDamage(7); // Deal 20 damage to the player
            }
    ...
    private boolean isCollidingWithPlayer(Player player) {
        ...
        double distance = Math.hypot(dx, dy);
        return distance < 30; // or your collision radius
    }
