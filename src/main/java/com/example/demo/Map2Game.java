...
public class Map2Game implements GameInterface{
    ...
    public void start() throws Exception {
        ...
        if (selectedAvatar == 0) {
            ...
            player = new Player2(1 * TILE_SIZE, 13 * TILE_SIZE, tileMap);
        }
        else if(selectedAvatar==2){
            player=new Player3(1 * TILE_SIZE, 13 * TILE_SIZE, tileMap);
        }
        ...
        gameLoop = new AnimationTimer() {
            ...
            public void handle(long now) {
                ...
                if (player.isAlive() && !isPaused) {
                    ...
                    winManager.checkAndShowWin(treasureManager, root, canvas, Map2Game.this, 5, mapName);
