...
public class Quiz2Controller {
    ...
    private void submitQuiz(ActionEvent event) {
        ...
        if (selected1 != null && selected1.getText().equals("Warm")) {
            score++;
        }

        // Question 2
        RadioButton selected2 = (RadioButton) group2.getSelectedToggle();
        if (selected2 != null && selected2.getText().equals("Pass")) {
            score++;
        }

        // Question 3
        RadioButton selected3 = (RadioButton) group3.getSelectedToggle();
        if (selected3 != null && selected3.getText().equals("Pause")) {
            score++;
        }

        // Question 4
        String q4 = answer4.getText().trim().toLowerCase();
        if (q4.contains("for") && q4.contains("printf")) {
            score++;
        }

        // Question 5
        String q5 = answer5.getText().trim().toLowerCase();
        if (q5.contains("while") && q5.contains("printf")) {
            score++;
        }
